(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".categories__slider")) new core(".tranding__slider ", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
    ...
    da.init();
    document.querySelector(".circle p").innerHTML = "NFT Marketplace Qeeb".split("").map(((e, i) => `<span style="--rot:${16 * i}deg">${e}</span>`)).join("");
    window["FLS"] = false;
    isWebp();
    menuInit();
    spollers();
